...
window.pg_config = {
    status: {
        102: "บัญชีหรือรหัสผ่านไม่ถูกต้อง",
        300: 'not login',
        404: " ขาดข้อมูล ",
        406: "ไม่พบตัวละคร",
        405: " ไม่มีกิจกรรมนี้",
    ...
    api: {
        ...
        // fb_redirect_uri: 'http://10.10.12.40:8020/oneyear/index.html',
    ...
    data: {
        ...
        groupId: '5a1d86f913294f55971e1ae5',
        version: 'v3',
        //累计日登陆
        actId1: '5a1d873313294f55971e1ae6',
        //活动竞猜
        actId2: '5a1d876d13294f55971e1ae7',
        //活跃人数
        actId3: '5a1d886213294f55971e1ae9',
        //抽奖
        actId4: '5a1d88e213294f55971e1aeb',
        //次数
        actId5: '5a1d890013294f55971e1aec',
        //充值
        actId6: '5a1d892a13294f55971e1aed',
        //todo 竞猜礼包
        giftId: ["5a1d8b8e13294f55971e1b04", "5a1d8bba13294f55971e1b06", "5a1d8bfb13294f55971e1b08"],
        count: 0,
        guessHis: []
    },
    tip: {
...
function checkLocalStorage() {
    try {
        if (!window.localStorage) {
            Raven.captureMessage('not support localStorage');
        }
    } catch (e) {
        console.log(e);
    }
...
function loadGameZones() {
    var localZones = null;
    try {
        localZones = MyLocalStorage.getJsonItem("zones");
        if (localZones) {
            globalData.zones = localZones;
        }
    } catch (e) {
        console.log(e);
    }
    if (!localZones && globalData.zones && globalData.zones.length == 0) {
        $.ajax({
...
function isLogin() {
    if (MyLocalStorage.getItem('userId') && MyLocalStorage.getItem('token')) {
        ...
        if (active < parseInt(MyLocalStorage.getItem('activetime'))) {
            ...
            globalData.zoneId = MyLocalStorage.getItem('zoneId');
...
function findZone(index) {
    var zones = globalData.zones, temp;
    if (!zones) {
        Raven.captureMessage('cannot find zoneInfo from local storage');
        return alert('cannot find zoneInfo from local storage, please update your browser');
    }
    if (index > zones.length) {
        return tip('抱歉,该区服还未开,请选择已开区服');
    }
    var finded = false;
    ...
    globalData.zoneId = zones[temp].thirdGameZoneId;
    globalData.gameZoneId = zones[temp].gameZoneId;
    MyLocalStorage.setItem("zoneId", zones[temp].thirdGameZoneId);
    MyLocalStorage.setItem("gameZoneId", zones[temp].gameZoneId);
    $.ajax({
...
var rewards = {
    id: {
        "5a1d8e2313294f55971e1b22": 0,
        "5a1d8e0613294f55971e1b20": 1,
        "5a1d8dc413294f55971e1b1e": 2,
        "5a1d8ed713294f55971e1b2a": 3,
        "5a1d8e3c13294f55971e1b24": 4,
        "5a1d8e5813294f55971e1b26": 5,
        "5a1d8ec013294f55971e1b28": 6,
        "5a1d8ef213294f55971e1b2c": 7
    },
    imgData: {
        "5a1d8dc413294f55971e1b1e": 'img/icon/ssp11.png',
        "5a1d8e0613294f55971e1b20": 'img/icon/ssmz1.png',
        "5a1d8e2313294f55971e1b22": 'img/icon/dsmz1.png',
        "5a1d8e3c13294f55971e1b24": 'img/icon/syqladn1.png',
        "5a1d8e5813294f55971e1b26": 'img/icon/ss1.png',
        "5a1d8ec013294f55971e1b28": 'img/icon/thx11.png',
        "5a1d8ed713294f55971e1b2a": 'img/icon/thx21.png',
        "5a1d8ef213294f55971e1b2c": 'img/icon/gjzb1.png'
    }
};
...
function ajaxDataController(url, params, successCallback) {
    $.ajax({
        ...
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            Raven.captureException(new Error(url + ',' + JSON.stringify(params) + ',' + JSON.stringify(XMLHttpRequest)));
            tip('request error');
        }
    });
}
...
$(".getBtn").on("click", function () {
    if (isLogin() && isChoose()) {
        ...
        ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
            if (result.code == 200) {
                gtag('event', 'firstdaysucess', {
                    'event_category': 'firstdaysucess_category',
                    'event_label': 'firstdaysucess_label'
                });
                ...
                Raven.captureMessage('dayClickgetBtn other code:' + result.code, {
            ...
            if (shutNum < 3) {
                ...
                ajaxDataController(requestUrl.joinActivityUrl, data, function (result) {
                    if (result.code == 200 || result.code == 1005) {
                        ...
                        Raven.captureMessage('submitBtnGetAwardClick other code:' + result.code, {
                            level: 'warning' // one of 'info', 'warning', or 'error'
                        });
                ...
                if (dataActId.length < 5) {
                    ...
                    ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
                        if (result.code == 200) {
                            ...
                            Raven.captureMessage('submitBtnClick other code:' + result.code, {
                                level: 'warning' // one of 'info', 'warning', or 'error'
                            });
    ...
    if (isLogin() && isChoose()) {
        ...
        ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
            if (result.code == 200) {
                ...
                Raven.captureMessage('pointBtnClick other code:' + result.code, {
                    level: 'warning' // one of 'info', 'warning', or 'error'
                });
                console.log('pointBtnClick' + pg_config.status[result.code]);
                tip(pg_config.status[result.code]);
            }
        });
    }
...
$(".startBtn").on("click", function () {
    ...
    if (isLogin() && isChoose()) {
        if (globalData.canLotteryCount > 0) {
            ...
            ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
                    if (result.code == 200) {
                        // MyLocalStorage.setItem('canLotteryCount', $(".count-desc span").text());
                        ...
                        $(".lottery-bg").rotate({
                            ...
                            callback: function () {
                                globalData.canLotteryCount--;
                                $(".count-desc span").text(globalData.canLotteryCount);
                        ...
                        Raven.captureMessage('startBtnLotteryClick other code:' + result.code, {
                            level: 'warning' // one of 'info', 'warning', or 'error'
                        });
                        console.log('startBtnLotteryClick' + pg_config.status[result.code]);
                        tip(pg_config.status[result.code]);
                    }
                }
            );
    ...
    if (isLogin() && isChoose()) {
        ...
        ajaxDataController(requestUrl.getHistroy, params, function (result) {
            if (result.code == 200) {
                ...
                Raven.captureMessage('getHistroyLotteryBtn other code:' + result.code, {
                    level: 'warning' // one of 'info', 'warning', or 'error'
                });
    ...
    if (isLogin() && isChoose()) {
        ...
        ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
            if (result.code == 200) {
                ...
                Raven.captureMessage('chargeBtnClick other code:' + result.code, {
                    level: 'warning' // one of 'info', 'warning', or 'error'
                });
                console.log('chargeBtnClick' + pg_config.status[result.code]);
                tip(pg_config.status[result.code]);
            }
        });
    }
...
function dayGetHistory() {
    ...
    ajaxDataController(requestUrl.getHistroy, params, function (result) {
        if (result.code == 200) {
            ...
            Raven.captureMessage('dayGetHistory other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function peopleGetHistory() {
    ...
    ajaxDataController(requestUrl.getHistroy, params, function (result) {
        if (result.code == 200) {
            ...
            Raven.captureMessage('peopleGetHistory other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function peopleJoinActivity() {
    ...
    ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
        if (result.code == 200) {
            ...
            Raven.captureMessage('peopleJoinActivity other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function chargeGetHistory() {
    ...
    ajaxDataController(requestUrl.getHistroy, params, function (result) {
        if (result.code == 200) {
            ...
            Raven.captureMessage('chargeGetHistory other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function chargeInfoActivity() {
    var params = {
        ...
        groupId: pg_config.data.groupId,
        token: globalData.token,
        rewardId: '5a1d903513294f55971e1b3e'
    };
    ajaxDataController(requestUrl.infoActivity, params, function (result) {
        if (result.code == 200) {
            ...
            Raven.captureMessage('chargeInfoActivity other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function countInfoActivity() {
    var params = {
        ...
        groupId: pg_config.data.groupId,
        token: globalData.token,
        rewardId: '5a1d8ef213294f55971e1b2c'
    };
    ajaxDataController(requestUrl.infoActivity, params, function (result) {
        if (result.code == 200) {
            var sumCount = result.state.consumeResource.sumCount;
            var usedCount = result.state.consumeResource.usedCount;
            // var canLotteryCount = 0;
            if (isNaN(sumCount) || isNaN(usedCount)) {
                Raven.captureMessage('countInfoActivity sumCount, userCount not a number ', {
                    level: 'warning' // one of 'info', 'warning', or 'error'
                });
            } else {
                globalData.canLotteryCount = sumCount - usedCount;
            }
            // MyLocalStorage.setItem("canLotteryCount", canLotteryCount);
            // var canLotteryCount = MyLocalStorage.getItem("canLotteryCount");
            $(".count-desc span").text(globalData.canLotteryCount);
        }
        else {
            Raven.captureMessage('countInfoActivity other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function getlotteryActivity() {
    var params = {
        ...
        groupId: pg_config.data.groupId,
        token: globalData.token,
        rewardId: '5a1d8da213294f55971e1b1c'
    };
    ajaxDataController(requestUrl.joinActivityUrl, params, function (result) {
        countInfoActivity();
    })
...
function getlotteryMoney() {
    ...
    ajaxDataController(requestUrl.infoActivity, params, function (result) {
        if (result.code == 200) {
            ...
            Raven.captureMessage('getLotteryMoney other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
...
function guessInfoActivity() {
    ...
    var params = {
        ...
        groupId: pg_config.data.groupId,
        token: globalData.token,
        rewardId: '5a1d876d13294f55971e1ae7'
    };
    ajaxDataController(requestUrl.infoActivity, params, function (result) {
        if (result.code == 200) {
            for (var z = 0; z < 3; z++) {
            ...
            Raven.captureMessage('guessInfoActivity other code:' + result.code, {
                level: 'warning' // one of 'info', 'warning', or 'error'
            });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.code == 200) {
                    ...
                    Raven.captureMessage('guessGetHistory other code:' + result.code, {
                        level: 'warning' // one of 'info', 'warning', or 'error'
                    });
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                Raven.captureException(new Error('guessGetHistory request error,' + JSON.stringify(XMLHttpRequest)));
                tip('request error');
            }
        });
